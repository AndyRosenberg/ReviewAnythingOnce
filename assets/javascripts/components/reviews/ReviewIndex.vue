<template>
  <div class="columns">
    <section class="section">
      <h1 class="is-size-1 mx-4 my-4 has-text-centered">Explore Reviews</h1>
...
<script>
  ...
  export default {
    ...
    created() {
      this.setPage(this.initialReviews);
    },
    ...
    methods: {
      setPage(pageData) {
        let pagination = typeof pageData === 'object' ? pageData : JSON.parse(pageData);
